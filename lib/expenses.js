...
export async function createExpenseWithCharges({ userId, name, total, date, myShare, month, charges, installmentPlanId = null }) {
  const [expense] = await sql`
    INSERT INTO expenses (user_id, name, total, date, my_share, month, installment_plan_id)
    VALUES (${userId}, ${name}, ${total}, ${date}, ${myShare}, ${month}, ${installmentPlanId})
    RETURNING id
  `;
